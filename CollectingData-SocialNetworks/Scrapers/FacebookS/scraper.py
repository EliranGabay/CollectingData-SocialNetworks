...
def scraper(**kwargs):
    with open(file_path+"\credentials.yaml", "r") as ymlfile:
    ...
    urls = [
        ...
        for line in open(file_path+"\input.txt", newline="\r\n")
...
if __name__ == "__main__":
    ...
    driver = None
    with open(file_path+"\selectors.json") as a, open(file_path+"\params.json") as b:
