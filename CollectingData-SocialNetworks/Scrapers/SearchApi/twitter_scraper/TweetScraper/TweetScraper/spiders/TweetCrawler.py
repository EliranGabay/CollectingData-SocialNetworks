...
from scrapy.utils.project import get_project_settings  # for debugging
import re
import json
import time
import logging
...
SETTINGS['SAVE_TWEET_PATH'] = './Data1/tweet/'
    ...
    def parse_tweet_item(self, items):
        for item in items:
            try:
                ...
                print(tweet['usernameTweet']+"=="+self.query)
                if (tweet['usernameTweet'] != self.query):
                    continue
